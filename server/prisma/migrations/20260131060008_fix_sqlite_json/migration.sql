...
CREATE TABLE "garnishments" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "garnishments_employeeId_fkey" FOREIGN KEY ("employeeId") REFERENCES "employees" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "payroll_runs" (
    ...
    "errorDetails" TEXT,
    "resultsSummary" TEXT,
    CONSTRAINT "payroll_runs_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "contractors" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "contractors_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "payrolls_companyId_payPeriodStart_payPeriodEnd_idx" ON "payrolls"("companyId", "payPeriodStart", "payPeriodEnd");
...
-- CreateIndex
CREATE INDEX "tax_configurations_jurisdiction_taxYear_idx" ON "tax_configurations"("jurisdiction", "taxYear");

-- CreateIndex
CREATE INDEX "tax_configurations_effectiveDate_idx" ON "tax_configurations"("effectiveDate");

-- CreateIndex
CREATE INDEX "tax_configurations_isActive_idx" ON "tax_configurations"("isActive");

-- CreateIndex
CREATE UNIQUE INDEX "tax_configurations_jurisdiction_taxYear_type_key" ON "tax_configurations"("jurisdiction", "taxYear", "type");
...
-- CreateIndex
CREATE INDEX "payroll_runs_queuedAt_idx" ON "payroll_runs"("queuedAt");

-- CreateIndex
CREATE INDEX "payroll_runs_payDate_idx" ON "payroll_runs"("payDate");
