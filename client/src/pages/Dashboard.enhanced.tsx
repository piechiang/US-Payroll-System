...
const RECENT_ACTIVITY = [
  { id: 1, action: 'Completed October payroll run', time: '2 hours ago', user: 'System' },
  { id: 2, action: 'New employee: John Doe added', time: 'Yesterday', user: 'HR Manager' },
  { id: 3, action: 'Updated tax compliance settings', time: '3 days ago', user: 'Finance' },
  { id: 4, action: 'Generated W-2 forms for 2023', time: '1 week ago', user: 'System' },
];
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <StatCard
          ...
          value="$124,500"
          subtext="Up 2.5% from last month"
          trend="up"
          icon={DollarSign}
          color="bg-indigo-500"
        />
      ...
      <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Link
            to="/employees/new"
            className="flex items-center space-x-3 p-4 border border-slate-200 rounded-lg hover:border-indigo-300 hover:bg-indigo-50 transition-colors group"
          >
